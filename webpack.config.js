  ...
  plugins: [
    new HtmlBundlerPlugin({
      ...
      entry: {
        ...
        'clinics/nsmc/index': 'src/views/pages/clinics/nsmc.html', // => dist/clinics/nsmc.html
        'clinics/cchnur-sultan/index': 'src/views/pages/clinics/cchnur-sultan.html', // => dist/clinics/cchnur-sultan.html
